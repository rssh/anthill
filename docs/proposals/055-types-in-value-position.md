...
**Status:** Draft (2026-07-13; revised 2026-08-23 after the proposals 060/062 compatibility review). **AMENDED BY [065](065-type-value-requirement.md) (2026-09-19, partly implemented 2026-09-20):** §2's type-PARAMETER bullet now carries a WELL-FORMEDNESS condition — a rigid denotes a `Type` value only where `requires TypeValue[T = B]` stands in scope, enforced at load since WI-20260919-N31XX — and §8's `type_value[T]()` is a member of that spec rather than a reader of the frame channel. The *classification* in §2 is unchanged, including "independent of the expected sort"; what 065 adds is a condition and a lowering, and the lowering is not built yet. Every other decision here stands — 065 §5 goes through them one by one.
