...
**§7 steps 1–4 are DONE** (BQHGD, HXGXF, N31XX, 891QP). **WHAT REMAINS:** §2's structural FORMERS (a named tuple or arrow has no sort to carry a provision — step 2), §7 step 5 (WI-20260919-H20YY), and open questions 1, 3 and 4 — **2 is answered**, by 28TAT removing the frame channel outright. Of those, 3 and 4 are the ones a program can still reach; 1 is deferred by decision.
