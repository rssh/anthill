```anthill
fact WorkItem(id: "WI-20260819-9C2PZ-wi-741-follow-up-rule-body-var", created: "2026-08-19T06:15:07Z", context: none, acceptance: [ToolPasses(tool: "cargo-test", params: none)], depends_on: some(value: nil), generates: none, requires_capability: none, status: Delivered(agent: "claude", at: "2026-08-19T10:07:35Z"))

fact Feedback(workitem: "WI-20260819-9C2PZ-wi-741-follow-up-rule-body-var", author: "claude", at: "2026-08-19T09:50:33Z")
```
