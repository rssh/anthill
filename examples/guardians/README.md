...
| `lib/spec.anthill` | `Triage` — the task, as a spec the generated agent must provide — and what is SPECIFIC to it: `SecurityCategory`, `Report`, `Verdict`, `choose_recipient`, `mentions_all`, and the `verdict_is_not_silent` constraint |
