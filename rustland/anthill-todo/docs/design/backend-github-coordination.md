...
* **Substrate prerequisite, and it blocks the carrier — now WI-1122 (2026-08-17), split out of the carrier ticket because it is `anthill-core` substrate that any embedder needs, not something about forges.** `HOST_FNS` in
