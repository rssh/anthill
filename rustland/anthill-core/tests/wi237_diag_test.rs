...
fn dump_eq_lt_rewrites() {
    ...
    files.push(common::workspace_root().join("anthill-todo/domain.anthill"));
    files.push(common::workspace_root().join("anthill-todo/rules.anthill"));
    files.push(common::workspace_root().join("anthill-todo/store.anthill"));
    files.push(common::workspace_root()
